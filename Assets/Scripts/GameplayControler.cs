...
public class GameplayControler : MonoBehaviour
{
    ...
    void DetermineWinner()
    {
        if (player_Choice == opponent_Choice)
        {
            ...
            infoText.text = "It's a DRAW = LYGIOSIOS !!!";
        ...
        {   
            //Player WON
            infoText.text = "You WIN = LAIMEJAI !!!";
            StartCoroutine(DisplayWinnerAndRestart());
        ...
        {   
            //Player LOSE
            infoText.text = "You LOSE = PRALAIMEJAI !!!";
            StartCoroutine(DisplayWinnerAndRestart());
        ...
        else if (opponent_Choice == GameChoices.SCISSORS && player_Choice == GameChoices.PAPER)
        {   
            //Player LOSE
            infoText.text = "You LOSE = PRALAIMEJAI !!!";
            StartCoroutine(DisplayWinnerAndRestart());
    ...
    IEnumerator DisplayWinnerAndRestart()
    {
        ...
        animationControler.ResetAnimations();
